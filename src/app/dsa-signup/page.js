...
export default function DSASignupPage() {
  ...
  return (
    <div className="relative flex min-h-screen md:h-screen md:overflow-hidden flex-col items-center justify-start md:justify-between bg-[#FAFAFA] bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(176,99,255,0.12),rgba(255,255,255,1))] pt-6 px-4 pb-4 sm:p-6 md:py-6 md:px-8 overflow-x-hidden">
      {/* Ambient Soft Glow Orbs */}
      <div className="absolute -top-24 -left-24 w-[320px] sm:w-[480px] h-[320px] sm:h-[480px] bg-[#B063FF]/15 rounded-full blur-[100px] sm:blur-[120px] pointer-events-none" />
      <div className="absolute top-1/3 -right-24 w-[300px] sm:w-[420px] h-[300px] sm:h-[420px] bg-[#B063FF]/10 rounded-full blur-[100px] sm:blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-4xl lg:max-w-5xl flex flex-col md:flex-1 my-0 md:my-auto max-h-full">
        ...
        <div className="flex items-center justify-between mb-2.5 px-1 sm:px-2 shrink-0">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            <div className="inline-flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 bg-[#B063FF] rounded-xl shadow-[0_4px_20px_rgba(176,99,255,0.35)] shrink-0">
            ...
            <div>
              ...
              <p className="text-[9px] sm:text-[10px] text-[#B063FF] font-semibold tracking-wide uppercase">
