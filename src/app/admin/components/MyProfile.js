      ...
      <div className="space-y-3 pt-4 border-t border-slate-200/80">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-2 text-xs">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-md bg-slate-900 hover:bg-slate-800 text-white font-medium text-xs transition-colors cursor-pointer self-start sm:self-auto"
          >
            Change Password
          </button>
        </div>
              ...
              <form onSubmit={handleSendOtp} className="space-y-4">
                ...
                <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-200/80">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1.5 rounded-md bg-slate-900 hover:bg-slate-800 text-white font-medium text-xs transition-colors cursor-pointer disabled:opacity-50"
                  >
            ...
            {step === 4 && (
              <div className="text-center py-4 space-y-3">
                ...
                <button
                  type="button"
                  onClick={() => setShowPasswordModal(false)}
                  className="w-full py-2 rounded-md bg-slate-900 hover:bg-slate-800 text-white font-medium text-xs transition-colors cursor-pointer"
                >
                  Close & Done
                </button>
              </div>
